...
function SectionDivider() {
  return <div className="mx-auto h-px w-full max-w-6xl bg-white/5 my-24" />;
}
    ...
    <section id="projects" className="mx-auto w-full max-w-6xl px-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        {projects.map((project) => (
          <div
            key={project.slug}
            className="group relative flex flex-col justify-between rounded-2xl border border-white/5 bg-white/[0.02] p-6 transition hover:border-white/10 hover:bg-white/[0.04]"
          >
            <div>
